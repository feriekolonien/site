    ...
    <Page title="Historie">
      ...
      <section className="mw7 center">
        <Text>
          ...
          Aulie i Trefoldighetskirken i Oslo. Hun ønsket å gi fattige familier i
          Oslo bedre muligheter, og på bare noen få år utrettet Gina Aulie flere
          gode tilbud for de som trengte det mest. Et av tilbudene som fortsatt
          er i drift i dag kom sommeren 1890. En feriekoloni for fattige bybarn.
          Rettere sagt et sommerparadis vekk fra Oslo og utslitte og fattige
          foreldre som trengte et avbrekk. Gina drev feriekolonien i mange år.
          Hun var hele Filtvet Feriekolonis hjerte sammen med sine lojale
          «tanter».
        </Text>
        <Text>
        ...
        <Text>
          I 1890 hadde Filtvet Feriekoloni sin første sommer. Idag er vi stolte
          av at Filtvet Feriekoloni er den lengst levende feriekolonien i landet
          med sine {new Date().getFullYear() - 1890} år.
        </Text>
      </section>
      <Footer />
    </Page>
