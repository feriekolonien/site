        ...
        <div className="grid grid-cols-1 items-center gap-x-8 gap-y-16 lg:grid-cols-2">
          ...
          <div className="mx-auto grid w-full max-w-xl grid-cols-2 items-center gap-y-12 sm:gap-y-14 lg:mx-0 lg:max-w-none lg:pl-8 gap-x-10">
            <a
              ...
              target="_blank"
              rel="noreferrer nofollow"
              title="Oslo domkirke sokn"
            >
              <img
                alt="Oslo domkirke"
                src="https://www.kirken.no/globalassets/fellesrad/oslo/menigheter/oslo-domkirke/bilder/ovrige-bilder--ukurante-strorrelser/oslo_domkirke_vaapenskjold_logo_tekst-red.png"
                width={105}
                height={48}
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer nofollow"
              title="Oslo kommune kulturetaten"
            >
              <svg
                ...
                className="max-h-12 w-full object-contain object-left"
                role="img"
                aria-labelledby="oslo-kommune-title"
              >
                <title>Oslo kommune kulturetaten</title>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer nofollow"
              title="Eckbos legat/ Ræder Bing"
            >
              <img
                alt="Eckbos legat/ Ræder Bing"
                src="https://www.eckbos-legat.no/patternlab/projects/eckboslegat/images/logo.svg"
                width={136}
                height={48}
                className="max-h-12 w-full object-contain object-left"
              />
            ...
            <a
              href="https://frimurer.no/index.php/velgjorenhetsdirektoriet"
              title="Stamhusets Velgjørenhetsstyre/ den norske frimurerorden Jakob Grova"
              target="_blank"
              rel="noreferrer nofollow"
            >
              <img
                alt="Den Norske Frimurerorden Logo"
                src="https://frimurer.no/images/elementer/den-norske-frimurerorden-logo@2x.png"
                width={140}
                height={140}
                className="max-h-[130px] w-full object-contain object-center"
              />
            </a>
            <a
              href="https://ricaeiendom.no/"
              title="Rica eiendom/ Jan Erik"
              target="_blank"
              rel="noreferrer nofollow"
            >
              <svg
